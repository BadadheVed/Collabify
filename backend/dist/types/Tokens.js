...
var generateToken = exports.generateToken = /*#__PURE__*/function () {
...
var verifyToken = exports.verifyToken = function verifyToken(token) {
  try {
    var isVerified = _jsonwebtoken["default"].verify(token, process.env.JWT_SECRET);
    return isVerified;
  } catch (error) {
    throw new Error("Error Verifying Token");
  }
};
var cookieOptions = exports.cookieOptions = {
  httpOnly: true,
  // Prevents client-side JS access
  secure: process.env.NODE_ENV === "production",
  // Only send over HTTPS in prod
  sameSite: "lax",
  // CSRF protection (can be 'lax', 'strict', or 'none')
